...
concentration and primary sequence.\cite{Cho2008,Nuhn2008} In addition, the interdependence of
biophysical properties of disparate
self-assembling domains as they exist as part of fusion constructs is still being
probed. 
...
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.65\textwidth]{f_1_04}
...
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.7\textwidth]{f_1_23}
...
subtle effects to the physicochemical properties of the polymers that are
...
and is reliant on their ability to assemble into supramolecular assemblies of
high density.
% --------------------------
...
constructs as NMR contrast agent. Aside from the various attempts to monitor the
...
reality. At the time of this publication, \iupac{trifluoro-\L-leucine} was
distributed from U.S. manufacturers for
\$\SIrange[range-phrase=--]{300}{500}{\per\gram}.

Yet another challenge still exists with respect to directing the concentration
of the proteins such that stock concentrations are not too high so as to offset
the ${T_t}$ of the stock preparation, resulting in a premature irreversible
coacervation event, would pose a challenge to any attempts to scale the
biosynthetic process. Furthermore, growth of elastin-like peptide-based
