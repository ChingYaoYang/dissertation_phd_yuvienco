...
subsequently freeze-dried prior to use in experiments. Gel lanes of pure protein
were used to quantitate post-purification yields, using an ImageQuant gel
...
% --------------------------
Biosynthetic yields for all three proteins were computed from the quantitation
of protein 
...
\begin{tabular}{ clllll }
  ...
  \hline
  Internal Standard & nmole Phe & nmole Val & Ratio Phe:Std & Ratio Phe:Std& \emph{p}FF \\
...
proteins. \emph{p}FF-EC was randomly structured at low temperatures.
