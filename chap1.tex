...
few groups have demonstrated an application of the polymeric motif with the use
of genetic
engineering.\cite{Higashiya2007,Lim2008a,Chen2008a,Xu2005,Osborne2008} These
groups leverage recombinant DNA technology to obtain
...
\SI{10}{\milli\moLar} Gomori buffer, by resuspending lyophilized protein and
...
\SI{2.5}{\mg\per\mL}, \emph{p}FF-EC was viscoelastic at \SI{22}{\celsius} at the same
concentration and both demonstrating more elastic character at \SI{42}{\celsius}
at \SI{10}{\mg\per\mL} (Figure \ref{fig:pFF_rheology}A,D
...
\emph{p}FF-ECE demonstrated a shift from viscous to viscoelastic at
