...
formation.\cite{} Indeed fluorination of synthetic polymers has been shown to
modulate supramolecular assemblies, confirming our results with protein
polymers.\cite{} While the mechanical properties of this collection of fusion
...
undergo chemical cross-linking.\cite{} In fact, the elastic moduli of the
...
\cite{} We further posit that cross-linking strategies could be applied to our
...
recombinantly produced spider silk.\cite{}
...
natural, this work demonstrates that the integration of fluorinated amino acids
...
established application of elastin-based protein polymers. Modifications to the
transition window have been effected in the past by changes in protein
concentration and block orientation.
