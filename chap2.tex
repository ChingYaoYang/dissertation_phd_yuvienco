...
\subsection{Cartilage oligomeric matrix protein}\footnote{This section was
previously presented in Chapter 1 of this document.}
...
methods.\cite{DeLeenheer1982,Kane2008,Wang2001a,Schaffer2010} However, BMS493
...
performed from 10:10:80 (ACN:MetOH:\ch{H2O}, \SI{0.1}{\percent} formic acid) to 45:45:10 (ACN:MetOH:\ch{H2O},
\SI{0.1}{\percent} formic acid) over \SI{30}{\minute} (data not shown). From
this optimization, maximal resolution and minimum peak width were determined to
be obtained using an isocratic mobile phase consisting of 41.2:41.2:17.6
(ACN:MetOH:\ch{H2O}, \SI{0.1}{\percent} formic acid). Elution of retinyl
palmitate requires a relatively abrupt gradient to \SI{100}{\percent} ACN, then
held isocratically for approximately \SI{3}{\minute} (Figure
\ref{fig:uplc_gradient}). 
% --------------------------
\begin{figure}[h!]
    \centering
    \begin{subfigure}[b]{0.75\textwidth}
        \includegraphics[width=\textwidth]{f_2_13a}
        \caption{UPLC gradient for chromatographic separation}
        \label{fig:uplc_gradient}
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \includegraphics[width=\textwidth]{f_2_13b}
        \caption{}
        \label{fig:std_chromatogram}
    \end{subfigure}
    \begin{subfigure}[b]{0.8\textwidth}
        \includegraphics[width=\textwidth]{f_2_13c}
        \caption{}
        \label{fig:retinoid_spectra}
    \end{subfigure}
    \caption{}\label{fig:uplc_report}
\end{figure}
% --------------------------
...
efficiency, or a \SI{0.36405}{\ng} injection. (Figure \ref{fig:extract_controls} 
% --------------------------
\begin{figure}[h!]
    \centering
    \begin{subfigure}[b]{0.75\textwidth}
    ...
    \end{subfigure}
    \caption{UPLC quantitation of BMS493 (\SI{3.1}{\minute}) in extract controls prepared in
    different media. Each sample was spiked with \SI{0.1}{\volper} \SI{1}{\milli\moLar}
    BMS493 prepared in DMSO}\label{fig:extract_controls}
\end{figure}
% --------------------------
This extraction protocol was applied to a preliminary set of culture samples
from a BMS493 dosage study, 
% --------------------------
\begin{figure}[h!]
    \centering
    \begin{subfigure}[b]{0.75\textwidth}
        ...
        \caption{}
        \label{fig:culture_extracts}
    \end{subfigure}

    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{f_2_15b}
        \caption{}
        \label{fig:culture_extracts_focus}
    \end{subfigure}
    \begin{subfigure}[b]{0.4\textwidth}
    ...
    \end{subfigure}
    \caption{}\label{fig:uplc_report_culture_extracts}
\end{figure}
% --------------------------
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption[Zonal elution profile for ATRA mixed with COMPcc]{(a) Zonal elution
        profile for COMPcc mixed with ATRA as a 1:1 mixture of
        \SI{25}{\micro\moLar} prepared in \SI{100}{\milli\moLar} Gomori
        phosphate buffer, pH 8.0, \SI{10}{\volper} ethanol. Darkening
        curves indicate an increase in incubation time from \SI{0}{\hour} to
        \SI{18}{\hour}. (b) Signal intensity increase at the peak absorption of
    each successive run. (c) Peak retention time/volume shift of each successive run.}\label{fig:zonal_elution_report}
\end{figure}
% --------------------------
